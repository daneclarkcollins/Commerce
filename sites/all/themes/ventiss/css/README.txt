...
To use these stylesheets, rename the files and ventiss with the name of your theme.
...
ventiss-alpha-default-narrow.css  
...
ventiss-alpha-default-normal.css
...
ventiss-alpha-default-wide.css
